...
VOID CFindGameObject::GetGameObjectName(_In_ DWORD dwNodeBase)
{
	...
	*/
	...
	WCHAR wszText[0x200] = { 0 };
	_wsName = std::wstring(MyTools::CCharacter::UTF8ToUnicode(wszText, szText));
}
...
VOID CFindGameObject::GetBuildName(_In_ DWORD dwNameObject, _Out_ CHAR* pszText) CONST
{
	...
	__try
	{
		...
		{
			MyTools::CCharacter::strcpy_my(pszText, reinterpret_cast<CONST CHAR*>(dwNamePtr), 32);
		}
	}
	__except (EXCEPTION_EXECUTE_HANDLER)
	{
